...
function RecentActivities({activitiesData}:RecentActivitiesProps) {
	return (
		<div className="p-8 bg-white rounded-[40px] w-[45%]">
			<div className="flex items-center justify-between mb-6">
				<h2 className="text-xl leading-[24.86px] font-semibold text-neutral-black">Recent Activities</h2>
				<SecondaryButton className="!text-blue-1 !text-[12px] !leading-4 max-w-[112px] hover:!border-blue-1">
					view all
				</SecondaryButton>
            </div>
